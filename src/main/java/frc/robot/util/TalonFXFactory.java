...
public class TalonFXFactory {
  ...
  private static final double kTimeoutSeconds = 0.05;

  private static final TalonFXConfiguration kDefaultConfiguration =
  ...
  public static TalonFX createTalon(int id, String canBus, TalonFXConfiguration config) {
    ...
    ErrorCheckUtil.checkError(
        talon.getConfigurator().apply(motorConfig), CommonErrorNames.ConfiguringTalon(id));
    return talon;
  }
}
