...
public class Wrist_Intake extends SubsystemBase {
  ...
  private TalonFX m_armLeader =
      TalonFXFactory.createTalon(
          WristConstants.armLeaderID,
          WristConstants.armTalonCANBus,
          WristConstants.kArmConfiguration);
  /** Creates a new Arm. */
  public Wrist_Intake() {}
  /**
   * PID arm to position
  ...
  public boolean isAtSetpoint() {
    return Math.abs(getSetpointError().getDegrees())
        <= WristConstants.angleErrorTolerance.getDegrees();
  }
